...
public class PlayerMovement1 : MonoBehaviour {
    ...
    //Crouch & Slide
    private Vector3 crouchScale = new Vector3(.2f, 0.1f, .2f);
    ...
    void Start() {
        ...
        wallRunning = GetComponent<WallRunningAdvanced>().wallRunning;
    }
    ...
    private void Movement() {
        ...
        rb.AddForce(player.transform.forward * -y * moveSpeed * Time.deltaTime
         * multiplier * multiplierV);
        rb.AddForce(player.transform.right * -x * moveSpeed * Time.deltaTime
         * multiplier);
    }
    ...
    private void Jump() {
        ...
        } else if ( !grounded && readyToJump && doubleJump && !wallRunning) {
